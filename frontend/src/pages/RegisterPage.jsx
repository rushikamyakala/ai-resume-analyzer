  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/3 left-1/3 w-64 h-64 bg-accent-500/5 rounded-full blur-3xl" />
      </div>
      ...
      <div className="w-full max-w-md animate-in relative">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-2 text-sm">Start analyzing your resume with AI today</p>
        </div>
        ...
        <div className="card-glow p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="label">Password <span className="text-slate-500 font-normal">(min. 6 characters)</span></label>
              <div className="relative">
